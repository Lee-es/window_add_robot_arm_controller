...
class BluetoothConstants {
  ...
  static const String robotArmAdvertisedUuid =
      '95484DB8-8566-0B54-EA54-53B5EE31789E';
  static const String robotArmServiceUuid =
      '9b666c50-66c1-48aa-a2b7-552eec397c02';
  static const String robotArmCharacteristicReadUuid =
      '958df18f-668f-480d-9660-37e37f67f5b4';
  static const String robotArmCharacteristicWriteUuid =
      '3b252962-6eac-43f7-b7d9-9293c392d72e';
  ...
  static const int cmdEmergencyStop =
      0x03; // [긴급 정지] 동작 중 일 경우 속도를 낮추고 천천히 정지를 하고 Torque는 설정
  static const int cmdStart =
      0x06; // [동작 시작] 걷기, 뛰기에 따라 설정 된 속도로 설정된 시간 동안만 동작.
  static const int cmdTurnTable =
      0x07; //[턴 테이블] 설정된 각도(-180 ~ 180)로 동작 단, 속도는 최대한 천천히 동작
