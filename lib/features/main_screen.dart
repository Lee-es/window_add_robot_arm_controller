            ...
            SizedBox(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const Expanded(flex: 1, child: DescriptionSection(text: '상의를 착의하기 위해서는 먼저 착의 버튼\n을 눌러 팔을 착의 자세로 위치하고, 착의 후\n에는 팔의 자세를 원위치로 위치합니다.')), 
                  Container(width: 1.0, color: AppColors.dividerColor),
                  const Expanded(flex: 2, child: DescriptionSection(text: "'걷기' 또는 '달리기'를 선택해 팔 흔들기 시간을 설정하고, 속도를 조절한 뒤 '동작 시\n작'을 누르면 팔이 움직입니다. 속도는 기본값 대비 ±10% 범위에서 조절할 수 있으\n며,필요 시 '긴급 정지' 버튼으로 즉시 멈출 수 있습니다.")),
                  Container(width: 1.0, color: AppColors.dividerColor),
                  const Expanded(flex: 1, child: DescriptionSection(text: "턴테이블의 정면 중앙이 '0' 이고, 좌측 회전\n 방향은 -방향, 우측 회전 방향은 + 방향을\n의미하고 각도를 10도 단위로 입력합니다.")),
                ],
              ),
            ),
          ],
